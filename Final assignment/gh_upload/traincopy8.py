...
class DiceCELoss(nn.Module):
    ...
    def forward(self, logits, targets):
        ...
        ce_loss = F.cross_entropy(logits, targets, ignore_index=self.ignore_index, label_smoothing=0.0)
...
def main(args):
    ...
    train_transforms = A.Compose([
        ...
        A.ShiftScaleRotate(
            shift_limit=0.05, scale_limit=0.1, rotate_limit=3, p=0.5, 
            border_mode=0 
        ),
    ...
    optimizer = torch.optim.AdamW([
        {'params': encoder_params, 'lr': 1e-4}, # Group 0: ResNet Encoder
        {'params': decoder_params, 'lr': 1e-3}  # Group 1: Decoder, ASPP, Attention
    ], weight_decay=0.01)
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images, labels) in enumerate(train_dataloader):
            ...
            # Simple loss calculation for ResNeXt-50
