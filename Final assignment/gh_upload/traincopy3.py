...
def main(args):
    ...
    # We identify encoder params by looking for ResNet-specific names
    for name, param in model.named_parameters():
        if any(key in name for key in ["stem", "layer1", "layer2", "layer3", "layer4"]):
            encoder_params.append(param)
        else:
            decoder_params.append(param)

    # 2. Define the optimizer with different Learning Rates
    # Here, we treat the encoder with 1/10th of the main learning rate
    optimizer = AdamW([
        {
