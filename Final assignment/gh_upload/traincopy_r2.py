...
def main(args):
    ...
    train_transforms = A.Compose([
        A.RandomResizedCrop(size=(256, 512), scale=(0.5, 1.0), p=1.0),
        A.HorizontalFlip(p=0.5),
        A.OneOf([
            A.RandomFog(fog_coef_lower=0.1, fog_coef_upper=0.4, p=1.0),
            A.RandomRain(brightness_coefficient=0.9, drop_length=10, p=1.0),
        ...
        A.OneOf([
            ...
            A.ToGray(p=1.0), # Forces reliance on shapes, not colors
        ], p=0.3),
        A.OneOf([
