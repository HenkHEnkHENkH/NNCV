...
class Model(nn.Module):
    def __init__(self, in_channels=3, n_classes=19):
        ...
        self.layer2 = self.backbone[2:4] 
        self.layer3 = self.backbone[4:6] 
        self.layer4 = self.backbone[6:8]

        self.aspp = ASPP(768, 512, rates=[1, 6, 12])

        # ===== Decoder =====
        self.up1 = nn.ConvTranspose2d(512, 256, 2, 2)
        self.att1 = AttentionGate(256, 384, 256)
        self.res1 = ResidualConv(256 + 384, 256)

        self.up2 = nn.ConvTranspose2d(256, 128, 2, 2)
        self.att2 = AttentionGate(128, 192, 128)
        self.res2 = ResidualConv(128 + 192, 128)

        self.up3 = nn.ConvTranspose2d(128, 64, 2, 2)
        self.att3 = AttentionGate(64, 96, 64)
        self.res3 = ResidualConv(64 + 96, 64)    

        self.up4 = nn.ConvTranspose2d(64, 64, 2, 2) 
        self.res4 = ResidualConv(64, 64)      
